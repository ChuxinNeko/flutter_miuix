...
flutter_miuix is a 1:1 port of [miuix](https://github.com/miuix-kotlin-multiplatform/miuix) (a Kotlin Compose Multiplatform UI library) to Flutter. It delivers the full Xiaomi HyperOS / MIUI-style component set: squircle corners, dynamic color (Monet), liquid-glass blur, and more.
